...
namespace webrtc {
    ...
    public:
        ...
        virtual void OnRecordAudio(const void *audioSamples, const size_t nSamples,
                                   ...
                                   const uint32_t samplesPerSec, const uint32_t totalDelayMS) = 0;
    };
    ...
    public:
        ...
        virtual int
        OnNeedPlayAudio(void *audioSamples, uint32_t &samplesPerSec, size_t &nChannels) = 0;
    };
    ...
    protected:
        ...
        virtual int32_t NeedMorePlayData(const size_t nSamples, const size_t nBytesPerSample,
                                         const size_t nChannels,
