...
//=================================================================
    JOWW(void, AnyRTMP_nativeInitCtx)(JNIEnv *jni, jclass, jobject context, jobject egl_context) {
        if (!av_static_initialized) {
            ...
            jclass j_eglbase14_context_class = webrtc_jni::FindClass(jni,
            ...
            if (jni->IsInstanceOf(egl_context, j_eglbase14_context_class)) {
                ...
                webrtc::AnyRtmpCore::Inst().SetExternalVideoEncoderFactory(
                        external_encoder.release());
            }
...
//=================================================================
    ...
    JOWW(void, RTMPHosterKit_nativeSetVideoCapturer)(JNIEnv *jni, jobject j_app,
    ...
    JOWW(void, RTMPHosterKit_nativeStartRtmpStream)(JNIEnv *jni, jobject j_app,
                                                    jstring j_rtmp_url) {
        JRTMPHosterImpl *jApp = (JRTMPHosterImpl *) GetJApp(jni, j_app);
...
//=================================================================
    ...
    JOWW(void, RTMPGuestKit_nativeStartRtmpPlay)(JNIEnv *jni, jobject j_app, jstring j_rtmp_url,
                                                 jlong j_renderer_pointer) {
