...
JRTMPGuestImpl::JRTMPGuestImpl(jobject javaObj)
        : m_pGuest(NULL), m_jJavaObj(NULL), m_jClass(NULL) {
    if (javaObj) {
...
void JRTMPGuestImpl::OnRtmplayerStatus(int cacheTime, int curBitrate) {
    ...
    {
        // Get *** callback interface method id
        jmethodID j_callJavaMId = webrtc_jni::GetMethodID(jni, m_jClass, "OnRtmplayerStatus",
                                                          "(II)V");
        // Callback with params
...
void JRTMPGuestImpl::OnRtmplayerCache(int time) {
    ...
    {
        // Get *** callback interface method id
        jmethodID j_callJavaMId = webrtc_jni::GetMethodID(jni, m_jClass, "OnRtmplayerCache",
                                                          "(I)V");
        // Callback with params
...
void JRTMPGuestImpl::OnRtmplayerClosed(int errcode) {
    ...
    {
        // Get *** callback interface method id
        jmethodID j_callJavaMId = webrtc_jni::GetMethodID(jni, m_jClass, "OnRtmplayerClosed",
                                                          "(I)V");
        // Callback with params
