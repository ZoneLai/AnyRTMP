...
public class CameraEnumerationAndroid {
    ...
    /**
     * @deprecated Please use Camera1Enumerator.getDeviceNames() instead.
     */
    @Deprecated
    ...
    /**
     * @deprecated Please use Camera1Enumerator.getDeviceNames().get(index) instead.
     */
    @Deprecated
    ...
    /**
     * @deprecated Please use Camera1Enumerator.isFrontFacing(String deviceName) instead.
     */
    @Deprecated
    ...
    /**
     * @deprecated Please use Camera1Enumerator.isBackFacing(String deviceName) instead.
     */
    @Deprecated
